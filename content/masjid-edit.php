...
<section class="content">
    <div class="box box-header">
        <div class="box-header with-border">
            <h3 class="box-title">Edit Struktur Masjid</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-default">
            <div class="row">
                <!-- Kolom Kiri -->
                <div class="col-md-6">
                    <form action="?hal=masjid-update" method="POST" enctype="multipart/form-data">
                        <div class="box-body">
                ...
                <div class="col-md-6">
                    <div class="box-body">
                        <div class="form-group row" style="display: flex; align-items: center;">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="ketua_takmir" id="ketua_takmir" class="form-control"
                                    value="<?= $ketua_takmir ?>">
                            </div>
                        </div>
                        <div class="form-group row" style="display: flex; align-items: center;">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="sekretaris" id="sekretaris" class="form-control"
                                    value="<?= $sekretaris ?>">
                            </div>
                        </div>
                        ...
                        <div class="box-footer">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <a href="?hal=masjid" class="btn btn-danger">Batal</a>
